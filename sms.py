...
class SendSms():
    ...
    def Dsmartgo(self):
        ...
        try:
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! --> Norris#0001")
        except AttributeError:
            print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! --> Norris#0001")
            self.adet += 1
    ...
    def Yaani(self):
        try:
            ...
            json={"action": "create", "email": f"{self.random_mail}@yaani.com", "language": "tr", "recovery_options": [{"type": "email", "value": self.mail}, {"type": "msisdn", "value": f"90{self.phone}"}]}
